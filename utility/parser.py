...
def parse_args():
    ...
    parser.add_argument('--proj_path', nargs='?', default='',
                        help='Project path.')
    parser.add_argument('--embedding_path', nargs='?', default='Embedding/')
    parser.add_argument('--ebd_save', type=int, default=0)
    parser.add_argument('--att_coef', type=float, default=1.0)
    parser.add_argument('--att_norm',type=int,default=0)
    ...
    parser.add_argument('--embed_size', type=int, default=64,
                        help='Embedding size.')
    parser.add_argument('--intra_emb_dim', type=int, default=1024)
    ...
    parser.add_argument('--gi_side',type = int, default= 1)
    parser.add_argument('--item_side', type=int, default=1)
    parser.add_argument('--att_ver', type=int, default=1)
    parser.add_argument('--gat_type', nargs='?', default=None)
    parser.add_argument('--aug_type', type=int, default=-1,
                        help='augmentation types.')
    parser.add_argument('--att_concat', type=int, default=0)
    ...
    parser.add_argument('--ssl_reg', type=float, default=0.1,
                        help='ssl_reg ')
    parser.add_argument('--ssl_mode', nargs='?', default='user_side',
                        help='ssl_mode.')
    parser.add_argument('--es_type', type=int, default = 0)
